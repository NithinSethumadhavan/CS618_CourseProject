...
public class SimpleStronglyLiveVariablesNew implements StronglyLiveVariablesNew
{
	private Map unitToExpressionsAfter;
	private Map unitToExpressionsBefore;

	public SimpleStronglyLiveVariablesNew(DirectedGraph graph) {
		SimpleStronglyLiveVariableAnalysisNew analysis = new SimpleStronglyLiveVariableAnalysisNew(graph);
		...
		while (unitIt.hasNext()) {
			...
			//System.out.println("Usage: java RunStronglyLiveVariableAnalysisNew class_to_analyse");
 ...
 *
 */
class SimpleStronglyLiveVariableAnalysisNew extends BackwardFlowAnalysis
{
	/**
	 * Just for clarity. 
	 */
	...
	public SimpleStronglyLiveVariableAnalysisNew(DirectedGraph g) {
		// First obligation
		super(g);
